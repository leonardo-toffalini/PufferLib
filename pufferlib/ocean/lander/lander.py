...
import pufferlib
from pufferlib.ocean.lander import binding

class Lander(pufferlib.PufferEnv):
...
if __name__ == '__main__':
    ...
    print('Lander SPS:', int(env.num_agents*steps / (time.time() - start)))
