// Standalone C demo for Phys environment
...
LinearContLSTM *make_linearcontlstm(Weights *weights, int num_agents,
                                    int input_dim, int logit_sizes[],
                                    int num_actions) {
...
void generate_dummy_actions(Phys *env) {
